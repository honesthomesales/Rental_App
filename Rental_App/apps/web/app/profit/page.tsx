    ...
    loadProfitData()
     ...
     try {
       ...
       if (payments.length === 0 && isInitialLoad) {
         const matchingPayments = allPayments.filter((p: any) => {
         ...
         if (matchingPayments.length === 0) {
           ...
           if (mostRecentMonth.month !== currentMonth || mostRecentMonth.year !== currentYear) {
        ...
        const collectedRentIncome = payments
          .filter((payment: any) => {
