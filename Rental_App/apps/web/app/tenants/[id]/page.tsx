                ...
                <div>
                  ...
                  {editing ? (
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, monthly_rent: parseFloat(e.target.value) || undefined })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  ) : (
                    <div className="flex items-center text-gray-900">
                ...
                <div>
                  ...
                  {editing ? (
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, security_deposit: parseFloat(e.target.value) || undefined })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  ) : (
                    <div className="flex items-center text-gray-900">
              ...
              <div>
                ...
                {tenant.lease_pdf_url ? (
                  <div className="flex items-center text-blue-600 hover:text-blue-800">
                    ...
                    <a href={tenant.lease_pdf_url} target="_blank" rel="noopener noreferrer">
                      View Lease Document
                    </a>
                  </div>
                ) : (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                tenant.is_active === true ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
              }`}>
