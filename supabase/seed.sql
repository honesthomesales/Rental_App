...
((SELECT id FROM RENT_properties WHERE name = 'Sunset Mobile Home Park Lot 101'), 'Sarah', 'Johnson', 'sarah.johnson@email.com', '512-555-0201', 'Mike Johnson', '512-555-0202', '2025-01-15', '2030-01-01', 1800.00, 1800.00, '[{"date": "2024-01-01", "amount": 1800.00, "status": "completed"}, {"date": "2024-02-01", "amount": 1800.00, "status": "completed"}]'::jsonb, 0.00, 'on_time', '2024-02-01', 'Reliable tenant, always pays on time', true),
((SELECT id FROM RENT_properties WHERE name = 'Oak Ridge House'), 'David', 'Chen', 'david.chen@email.com', '512-555-0301', 'Lisa Chen', '512-555-0302', '2025-01-15', '2030-01-01', 2800.00, 2800.00, '[{"date": "2024-01-01", "amount": 2800.00, "status": "completed"}, {"date": "2024-02-01", "amount": 2800.00, "status": "completed"}]'::jsonb, 0.00, 'on_time', '2024-02-01', 'Professional tenant, works from home', true),
((SELECT id FROM RENT_properties WHERE name = 'Riverside Doublewide'), 'Emily', 'Rodriguez', 'emily.rodriguez@email.com', '512-555-0401', 'Carlos Rodriguez', '512-555-0402', '2025-01-15', '2030-01-01', 2200.00, 2200.00, '[{"date": "2024-01-01", "amount": 2200.00, "status": "completed"}, {"date": "2024-02-01", "amount": 2200.00, "status": "completed"}]'::jsonb, 0.00, 'on_time', '2024-02-01', 'Family with 2 kids, very quiet', true),
((SELECT id FROM RENT_properties WHERE name = 'Mobile Home Park Lot 15'), 'ABC Coffee Shop', 'ABC Coffee', 'manager@abccoffee.com', '512-555-0501', 'Maria Garcia', '512-555-0502', '2025-01-15', '2030-01-01', 1400.00, 1400.00, '[{"date": "2024-01-01", "amount": 1400.00, "status": "completed"}, {"date": "2024-02-01", "amount": 1400.00, "status": "completed"}]'::jsonb, 0.00, 'on_time', '2024-02-01', 'Commercial tenant - coffee shop storage', true),
((SELECT id FROM RENT_properties WHERE name = 'Sunset Mobile Home Park Lot 101'), 'Late', 'Tenant', 'late.tenant@email.com', '512-555-0601', 'Emergency Contact', '512-555-0602', '2025-01-15', '2030-01-01', 1800.00, 1800.00, '[]'::jsonb, 0.00, 'late', '2025-01-15', 'Tenant with late payments for testing', true);
