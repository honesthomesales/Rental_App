-- Clean up duplicate rent_generate_periods functions
-- Drop all existing versions and create the correct one

-- Drop all existing versions
DROP FUNCTION IF EXISTS rent_generate_periods(UUID);
DROP FUNCTION IF EXISTS rent_generate_periods(UUID, INTEGER);

-- Create the correct version with only p_lease_id parameter
